...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["password"]))){
        $password_err = "Please enter a valid PIN number.";
    } else{
...
<div class="topnav" id="myTopnav">
  ...
  <a href="studentLogin.php" class="active">Student</a>
    ...
    <div class="wrapper" style="width:300px; justify-content:center;  height: 200px; align-items:center; margin:auto;">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group">
                <label>PIN</label>
                <input type="number" name="password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>">
